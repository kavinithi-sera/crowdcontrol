    ...
    <>
      ...
      {!isOpen && (
        <button 
          ...
          className="fixed bottom-6 right-6 w-16 h-16 rounded-full premium-gradient shadow-[0_0_20px_rgba(124,58,237,0.5)] flex items-center justify-center text-white hover:scale-110 transition-transform z-40"
        >
      ...
      <div 
        className={`fixed inset-x-0 bottom-0 z-50 transform transition-transform duration-500 ease-in-out ${isOpen ? 'translate-y-0' : 'translate-y-full'}`}
      >
        <div className="glass border-t border-white/10 rounded-t-[2.5rem] p-6 shadow-2xl h-[85vh] overflow-hidden w-full md:max-w-md md:right-6 md:left-auto md:w-[450px] md:h-[700px] md:bottom-6 md:rounded-[2.5rem] md:border border-white/10 flex flex-col items-stretch max-w-full">
          ...
          {!route ? (
            ...
            <div className="flex flex-col h-full overflow-hidden">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-background to-transparent pt-12">
                  <button 
